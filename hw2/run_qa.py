...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.train_file is not None:
            ...
            print( "extension : ", data_files["train"] )
        ...
        if data_args.test_file is not None:
            ...
            print( "extension : ", data_files["test"] )
            print( "extension : ", extension )
        raw_datasets = load_dataset(
            extension,
    ...
    def prepare_train_features(examples):
        ...
        for i, offsets in enumerate(offset_mapping):
            ...
            if len(examples["answer_start"]) == 0:
                ...
                # print("start_char : ", examples["answer_start"][sample_index])
                # print("examples[answer_text] : ", examples["answer_text"][sample_index])
